...
export function BottomNav({
  ...
  return (current?.prev || current?.next) && <div className="flex flex-wrap items-stretch justify-between gap-2 pb-6 w-full min-w-[1px] max-w-full">
    {current?.prev && <Link href={current.prev.href ?? ""} className="flex-1 min-w-[1px] w-auto flex px-9 py-3 items-center justify-start text-lg rounded-md border border-transparent cursor-pointer hover:bg-purple-500/20 hover:border-purple-500/20 focus:bg-purple-500/20 focus:border-purple-500/20 active:bg-purple-500/20 active:border-purple-500/20">
    ...
    {current?.next && <Link href={current.next.href ?? ""} className="flex-1 min-w-[1px] w-auto flex px-9 py-3 items-center justify-end text-lg rounded-md border border-transparent cursor-pointer hover:bg-purple-500/20 hover:border-purple-500/20 focus:bg-purple-500/20 focus:border-purple-500/20 active:bg-purple-500/20 active:border-purple-500/20">
      <div className="flex items-end justify-stretch gap-5 min-w-[1px]">
